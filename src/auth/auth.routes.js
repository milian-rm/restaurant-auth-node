 ...
 */
router.post('/login', authRateLimit, upload.none(), validateLogin, authController.login);
router.post('/login-client', authRateLimit, upload.none(), validateLogin, authController.loginClient);
